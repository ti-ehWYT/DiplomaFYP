...
function showResult(){
    ...
    if (userScore > 3){ // if user scored more than 3
        ...
        let scoreTag = '<span>Welldone!! You got <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        ...
        let scoreTag = '<span>Opss.. You got only <p>'+ userScore +'</p> out of <p>'+ questions.length +'</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
function startTimerLine(time){
    ...
    function timer(){
        ...
        if(time > 548){ //if time value is greater than 549
            clearInterval(counterLine); //clear counterLine
        }
    }
}
